  ...
  return (
    <div className="package">
        ...
        <form className="package-form" onSubmit={handleSubmit}>
            <TextField label="Name" value={name} onChange={(event)=>{setName(event.target.value)}} type="text" sx={{ width: 500 }} required variant="standard"></TextField>
